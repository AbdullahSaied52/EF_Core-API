...
GET    /api/Main/Get-Student-Enrollments/{student\_id}

GET    /api/Main/Get-Students-By-Course/{course\_id}

GET    /api/Main/Get-Student-Profile/{student\_id}



PUT    /api/Main/Update-Student-Status/{student\_id}

PUT    /api/Main/Update-Enrollment/{student\_id}/{course\_code}



DELETE /api/Main/Delete-Student/{student\_id}
